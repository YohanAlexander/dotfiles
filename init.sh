if [ "$(uname)" == "Darwin" ]; then
    ...
    brew install kitty zsh ranger git-delta fd bat w3m imagemagick autojump tldr ripgrep the_silver_searcher
    ...
    # install spotify and webtorrent
    flatpak install flathub com.spotify.Client && flatpak install flathub io.webtorrent.WebTorrent
